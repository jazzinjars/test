package com.jazzinjars.user.details.contacts;
...
public class ContactsServiceClient {
    ...
    public ContactsServiceClient(final RestTemplateBuilder restTemplateBuilder, @Value("${contacts.service.url}") final String contactsServiceUrl) {
